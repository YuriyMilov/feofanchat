...
public class st {
	...
	static public  OWLOntology ontology;
	static public  OWLDataFactory factory;
	static public OWLIndividual Сократ=null;
	static public OWLIndividual Платон=null;
	static public OWLObjectProperty учит=null;
	static public OWLClass ученик =null;
	static public OWLClass учитель =null;	
	...
	static public void class_equiv_to_1_ind(OWLClassExpression нечто, OWLIndividual Сократ) {
		OWLObjectOneOf сократы = factory.getOWLObjectOneOf(Сократ);
		OWLClassAxiom аксиома = factory.getOWLEquivalentClassesAxiom(нечто,сократы);
		manager.addAxiom(ontology, аксиома);
